 ...
 * @date 2019年10月7日
 */
package linxiao.he.menu_test3;

import java.util.Scanner;
import java.util.regex.*;
import java.util.Random;

public class Menu_test3 {
    static int nowUser = 0;
    ...
    static String[] emailArray = new String[100];
    static String[] answerArray = new String[100];
    static int[] questionOptionArray = new int[100];
    ...
    public static String nameCheak() {
        ...
        while (isCheak) {
            ...
            for (int i = 0; i < nowUser; i++) {
                String string = userNameArray[i];
                if (string.equals(namec)) {
                    isTrue = true;
                    na = nameArray[i];
                    String string1 = passWordArray[i];
...
//    	userNameArray[0] = "qwe123";
//        passWordArray[0] = "qwer1234?";
//        nameArray[0] = "qwe";
//        emailArray[0] = "123@qq.com";
//        questionOptionArray[0] = 3;
//        answerArray[0] = "qw";
//        nowUser=1;
    	...
    	for (int i = 0; i < nowUser; i++) {
            String string = userNameArray[i];
            if (string.equals(namec)) {
            	switch (questionOptionArray[i]) {
				case 1:	
					System.out.println("1.你小学的名字是什么？");
					System.out.println("请输入答案：");
					anString=input.next();
					if (anString.equals(answerArray[i])) {
    ...
    public static void showMenu2() {
        ...
        switch (option1) {
            ...
            case 1:
                ...
                userNameArray[nowUser] = userName;
                passWordArray[nowUser] = password;
                nameArray[nowUser] = showName;
                emailArray[nowUser] = email;
                questionOptionArray[nowUser] = questionNo;
                answerArray[nowUser] = answer;
                nowUser++;
                showMenu2();
                break;
